...
* Subject: a number referencing the subject (person) being measured (range 1:30)
* Activity: the name of the activity being performed by the subject

* Body Acceleration data, measured over a time frame:
   + tBodyAcc-mean-X
   + tBodyAcc-mean-Y
   + tBodyAcc-mean-Z
   + tBodyAcc-std-X
...
* Gravity acceleration data, measured over a time frame:   
   + tGravityAcc-mean-X
   + tGravityAcc-mean-Y
   + tGravityAcc-mean-Z
   + tGravityAcc-std-X
...
* Body jerk acceleration, measured over a time frame:
   + tBodyAccJerk-mean-X
   + tBodyAccJerk-mean-Y
   + tBodyAccJerk-mean-Z
   + tBodyAccJerk-std-X
...
* Body gyro-meaurements over a time frame:
   + tBodyGyro-mean-X
   + tBodyGyro-mean-Y
   + tBodyGyro-mean-Z
   + tBodyGyro-std-X
...
* Body gyro-jerk measurements over a time frame:
