...
Descriptions:
**x_cast** - is a summary data set holding the mean of each measurement's values for each subject and activity combination, x_cast is printed by the script as a tidy_data.txt file.

x_cast is a data frame, 88 columns wide, 180 rows (all combinations of 6 activities x 30 subjects).
