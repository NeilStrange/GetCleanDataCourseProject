...
* To find which columns to keep:
    ...
    + some of these hold text fragments 'mean' or 'std' - which we should keep
...
* Use the keep vector to drop any columns we don't need in x_data
* Note that columns 1-2 contain subject and activity data and are retained
